...
class CreatePreparedSubscription implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreatePreparedSubscription., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreatePreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanVersion($planVersion)
    {
        ...
        if (!is_null($planVersion) && ($planVersion < 1)) {
            throw new \InvalidArgumentException('invalid value for $planVersion when calling CreatePreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setGraceDuration($graceDuration)
    {
        ...
        if (!is_null($graceDuration) && ($graceDuration < 0)) {
            throw new \InvalidArgumentException('invalid value for $graceDuration when calling CreatePreparedSubscription., must be bigger than or equal to 0.');
        }
