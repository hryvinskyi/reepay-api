 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreatePreparedSubscription implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['plan_version']) && ($this->container['plan_version'] < 1.0)) {
            $invalid_properties[] = "invalid value for 'plan_version', must be bigger than or equal to 1.0.";
        }

        if (!is_null($this->container['grace_duration']) && ($this->container['grace_duration'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'grace_duration', must be bigger than or equal to 0.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['plan_version'] < 1.0) {
            return false;
        }
        if ($this->container['grace_duration'] < 0.0) {
            return false;
        }
        return true;
    }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreatePreparedSubscription., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreatePreparedSubscription., must be bigger than or equal to 1.0.');
        }
    ...
    public function setPlanVersion($plan_version)
    {
        ...
        if ($plan_version < 1.0) {
            throw new \InvalidArgumentException('invalid value for $plan_version when calling CreatePreparedSubscription., must be bigger than or equal to 1.0.');
        }
    ...
    public function setGraceDuration($grace_duration)
    {
        ...
        if ($grace_duration < 0.0) {
            throw new \InvalidArgumentException('invalid value for $grace_duration when calling CreatePreparedSubscription., must be bigger than or equal to 0.0.');
        }
