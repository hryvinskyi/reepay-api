...
class CreateSubscriptionPlan implements ModelInterface, ArrayAccess
{
     ...
     * Sets currency
     *
     * @param string $currency Currency for the subscription plan in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) three letter alpha code. If not provided the account default currency will be used.
     *
     * @return $this
     */
