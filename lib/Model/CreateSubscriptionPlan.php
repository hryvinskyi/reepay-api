...
/**
 * CreateSubscriptionPlan Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Reepay
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateSubscriptionPlan implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CreateSubscriptionPlan';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['setup_fee']) && ($this->container['setup_fee'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'setup_fee', must be bigger than or equal to 0.0.";
        }

        if (!is_null($this->container['minimum_prorated_amount']) && ($this->container['minimum_prorated_amount'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'minimum_prorated_amount', must be bigger than or equal to 0.0.";
        }
        ...
        if (!is_null($this->container['notice_periods']) && ($this->container['notice_periods'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'notice_periods', must be bigger than or equal to 0.0.";
        }

        if (!is_null($this->container['fixation_periods']) && ($this->container['fixation_periods'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'fixation_periods', must be bigger than or equal to 0.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['setup_fee'] < 0.0) {
            return false;
        }
        if ($this->container['minimum_prorated_amount'] < 0.0) {
            return false;
        }
        ...
        if ($this->container['notice_periods'] < 0.0) {
            return false;
        }
        if ($this->container['fixation_periods'] < 0.0) {
            return false;
        }
        return true;
    }
    ...
    public function setVat($vat)
    {
        ...
        if ($vat > 1.0) {
            throw new \InvalidArgumentException('invalid value for $vat when calling CreateSubscriptionPlan., must be smaller than or equal to 1.0.');
        }
        if ($vat < 0.0) {
            throw new \InvalidArgumentException('invalid value for $vat when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setRenewalReminderEmailDays($renewal_reminder_email_days)
    {
        ...
        if ($renewal_reminder_email_days < 1.0) {
            throw new \InvalidArgumentException('invalid value for $renewal_reminder_email_days when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setTrialReminderEmailDays($trial_reminder_email_days)
    {
        ...
        if ($trial_reminder_email_days < 1.0) {
            throw new \InvalidArgumentException('invalid value for $trial_reminder_email_days when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setSetupFee($setup_fee)
    {
        ...
        if ($setup_fee < 0.0) {
            throw new \InvalidArgumentException('invalid value for $setup_fee when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setMinimumProratedAmount($minimum_prorated_amount)
    {
        ...
        if ($minimum_prorated_amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $minimum_prorated_amount when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setFixedCount($fixed_count)
    {
        ...
        if ($fixed_count < 1.0) {
            throw new \InvalidArgumentException('invalid value for $fixed_count when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setFixedLifeTimeLength($fixed_life_time_length)
    {
        ...
        if ($fixed_life_time_length < 1.0) {
            throw new \InvalidArgumentException('invalid value for $fixed_life_time_length when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setTrialIntervalLength($trial_interval_length)
    {
        ...
        if ($trial_interval_length < 1.0) {
            throw new \InvalidArgumentException('invalid value for $trial_interval_length when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setIntervalLength($interval_length)
    {
        ...
        if ($interval_length < 1.0) {
            throw new \InvalidArgumentException('invalid value for $interval_length when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setScheduleFixedDay($schedule_fixed_day)
    {
        ...
        if ($schedule_fixed_day > 28.0) {
            throw new \InvalidArgumentException('invalid value for $schedule_fixed_day when calling CreateSubscriptionPlan., must be smaller than or equal to 28.0.');
        }
        if ($schedule_fixed_day < 1.0) {
            throw new \InvalidArgumentException('invalid value for $schedule_fixed_day when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setBaseMonth($base_month)
    {
        ...
        if ($base_month > 12.0) {
            throw new \InvalidArgumentException('invalid value for $base_month when calling CreateSubscriptionPlan., must be smaller than or equal to 12.0.');
        }
        if ($base_month < 1.0) {
            throw new \InvalidArgumentException('invalid value for $base_month when calling CreateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setNoticePeriods($notice_periods)
    {
        ...
        if ($notice_periods < 0.0) {
            throw new \InvalidArgumentException('invalid value for $notice_periods when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setFixationPeriods($fixation_periods)
    {
        ...
        if ($fixation_periods < 0.0) {
            throw new \InvalidArgumentException('invalid value for $fixation_periods when calling CreateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
