 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlanList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlanList';
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PlanList., must be smaller than or equal to 100.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PlanList., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PlanList., must be smaller than or equal to 100.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PlanList., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Reepay\Model\Plan[] $content List of plans for current page
     *
     * @return $this
     */
