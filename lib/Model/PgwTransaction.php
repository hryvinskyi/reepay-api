...
/**
 * PgwTransaction Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Reepay
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PgwTransaction implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PgwTransaction';
    ...
    const TYPE_NOW = 'klarna_pay_now';
    const TYPE_LATER = 'klarna_pay_later';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pgw_id'] = isset($data['pgw_id']) ? $data['pgw_id'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("klarna_pay_now", "klarna_pay_later");
    ...
    /**
     * Sets type
     * @param string $type Transaction type: `klarna_pay_now` or `klarna_pay_later`
     * @return $this
     */
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'klarna_pay_now', 'klarna_pay_later'");
        }
    ...
    {
        return $this->container['pgw_id'];
    }

    /**
     * Sets pgw_id
     * @param string $pgw_id Payment Gateway id
     * @return $this
     */
    public function setPgwId($pgw_id)
    {
        $this->container['pgw_id'] = $pgw_id;
