...
/**
 * TrustlyTransaction Class Doc Comment
 *
 * @category Class
 * @description Specifics in case of Trustly transaction
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrustlyTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TrustlyTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trustly_id'] = isset($data['trustly_id']) ? $data['trustly_id'] : null;
    }
     ...
     * @return string
     */
    public function getTrustlyId()
    {
        return $this->container['trustly_id'];
    }

    /**
     * Sets trustly_id
     *
     * @param string $trustly_id Trustly id
     *
     * @return $this
     */
    public function setTrustlyId($trustly_id)
    {
        $this->container['trustly_id'] = $trustly_id;
