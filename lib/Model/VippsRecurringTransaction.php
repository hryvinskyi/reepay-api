...
/**
 * VippsRecurringTransaction Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VippsRecurringTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VippsRecurringTransaction';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vipps_recurring_mandate'] === null) {
            $invalidProperties[] = "'vipps_recurring_mandate' can't be null";
        }
