...
class KlarnaTransaction implements ArrayAccess
{
    ...
    const TYPE_PAY_NOW = 'klarna_pay_now';
    const TYPE_PAY_LATER = 'klarna_pay_later';
    const TYPE_SLICE_IT = 'klarna_slice_it';
    const TYPE_DIRECT_BANK_TRANSFER = 'klarna_direct_bank_transfer';
    const TYPE_DIRECT_DEBIT = 'klarna_direct_debit';
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'klarna_pay_now', 'klarna_pay_later', 'klarna_slice_it', 'klarna_direct_bank_transfer', 'klarna_direct_debit'");
        }
