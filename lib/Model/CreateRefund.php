...
class CreateRefund implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 1.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateRefund., must be bigger than or equal to 1.0.');
        }
    ...
    /**
     * Sets note_lines
     * @param \Reepay\Model\CreateCreditNoteLine[] $note_lines Refund credit note lines to give detailed information for credit note. Either this or `amount` must be provided.
     * @return $this
     */
     ...
     * @param \Reepay\Model\ManualRefundTransfer $manual_transfer Optional manual transfer. If given no refund will be performed on potential online settled transaction like card transaction.
     * @return $this
     */
