...
class Transaction implements ModelInterface, ArrayAccess
{
     ...
     * Sets currency
     *
     * @param string $currency Currency in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) three letter alpha code
     *
     * @return $this
     */
     ...
     * Sets payment_type
     *
     * @param string $payment_type Payment type for transaction, either: `card`, `mpo`, `mobilepay`, `vipps`, `vipps_recurring`, `swish`, `viabill`, `anyday`, `manual`, `applepay`, `googlepay`, `paypal`, `klarna_pay_now`, `klarna_pay_later`, `klarna_slice_it`, `klarna_direct_bank_transfer`, `klarna_direct_debit`, `resurs`, `santander`, `mobilepay_subscriptions`, `emv_token`, `bcmc`, `blik`, `pp_blik_oc`, `giropay`, `ideal`, `p24`, `sepa`, `trustly`, or `verkkopankki`, `offline_cash`, `offline_bank_transfer`, `offline_other`
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\SantanderTransaction $santander_transaction santander_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\TrustlyTransaction $trustly_transaction trustly_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\EpsTransaction $eps_transaction eps_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\EstoniaBanksTransaction $estonia_banks_transaction estonia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\LatviaBanksTransaction $latvia_banks_transaction latvia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\LithuaniaBanksTransaction $lithuania_banks_transaction lithuania_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\MbwayTransaction $mbway_transaction mbway_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\MultibancoTransaction $multibanco_transaction multibanco_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\MybankTransaction $mybank_transaction mybank_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\PayconiqTransaction $payconiq_transaction payconiq_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\PaysafecardTransaction $paysafecard_transaction paysafecard_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\PayseraTransaction $paysera_transaction paysera_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\PostfinanceTransaction $postfinance_transaction postfinance_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\SatispayTransaction $satispay_transaction satispay_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Reepay\Model\WeChatPayTransaction $wechatpay_transaction wechatpay_transaction
     *
     * @return $this
     */
