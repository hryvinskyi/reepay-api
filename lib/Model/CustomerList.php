...
class CustomerList implements ModelInterface, ArrayAccess
{
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CustomerList., must be smaller than or equal to 100.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CustomerList., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100)) {
            throw new \InvalidArgumentException('invalid value for $count when calling CustomerList., must be smaller than or equal to 100.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling CustomerList., must be bigger than or equal to 0.');
        }
