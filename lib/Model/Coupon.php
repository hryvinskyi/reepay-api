...
class Coupon implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_redemptions']) && ($this->container['max_redemptions'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'max_redemptions', must be bigger than or equal to 0.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['max_redemptions'] < 0.0) {
            return false;
        }
        $allowed_values = array("early", "valid_until", "max");
        if (!in_array($this->container['expire_reason'], $allowed_values)) {
    ...
    public function setMaxRedemptions($max_redemptions)
    {
        ...
        if ($max_redemptions < 0.0) {
            throw new \InvalidArgumentException('invalid value for $max_redemptions when calling Coupon., must be bigger than or equal to 0.0.');
        }
