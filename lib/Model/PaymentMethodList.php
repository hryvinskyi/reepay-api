 ...
 *
 * @category Class
 * @description A page in a paginated payment method list
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentMethodList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentMethodList';
    ...
    protected static $swaggerTypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Reepay\Model\PaymentMethodV2[]',
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PaymentMethodList., must be smaller than or equal to 100.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PaymentMethodList., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PaymentMethodList., must be smaller than or equal to 100.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PaymentMethodList., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Reepay\Model\PaymentMethodV2[] $content List of payment methods for current page
     *
     * @return $this
     */
