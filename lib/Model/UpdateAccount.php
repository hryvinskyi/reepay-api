...
class UpdateAccount implements ArrayAccess
{
    ...
    public function setDefaultVat($default_vat)
    {
        ...
        if ($default_vat > 1.0) {
            throw new \InvalidArgumentException('invalid value for $default_vat when calling UpdateAccount., must be smaller than or equal to 1.0.');
        }
        if ($default_vat < 0.0) {
            throw new \InvalidArgumentException('invalid value for $default_vat when calling UpdateAccount., must be bigger than or equal to 0.0.');
        }
