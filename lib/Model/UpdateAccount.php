...
class UpdateAccount implements ModelInterface, ArrayAccess
{
    ...
    public function setDefaultVat($defaultVat)
    {
        ...
        if (($defaultVat > 1)) {
            throw new \InvalidArgumentException('invalid value for $defaultVat when calling UpdateAccount., must be smaller than or equal to 1.');
        }
        if (($defaultVat < 0)) {
            throw new \InvalidArgumentException('invalid value for $defaultVat when calling UpdateAccount., must be bigger than or equal to 0.');
        }
