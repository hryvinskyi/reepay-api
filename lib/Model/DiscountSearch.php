...
/**
 * DiscountSearch Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DiscountSearch implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DiscountSearch';
    ...
    public function setPage($page)
    {
        ...
        if ($page < 1.0) {
            throw new \InvalidArgumentException('invalid value for $page when calling DiscountSearch., must be bigger than or equal to 1.0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if ($size < 1.0) {
            throw new \InvalidArgumentException('invalid value for $size when calling DiscountSearch., must be bigger than or equal to 1.0.');
        }
    ...
    public function setCount($count)
    {
        ...
        if ($count < 0.0) {
            throw new \InvalidArgumentException('invalid value for $count when calling DiscountSearch., must be bigger than or equal to 0.0.');
        }
    ...
    /**
     * Sets content
     * @param \Reepay\Model\Discount[] $content List of discounts for current page
     * @return $this
     */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if ($total_elements < 0.0) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling DiscountSearch., must be bigger than or equal to 0.0.');
        }
    ...
    public function setTotalPages($total_pages)
    {
        ...
        if ($total_pages < 0.0) {
            throw new \InvalidArgumentException('invalid value for $total_pages when calling DiscountSearch., must be bigger than or equal to 0.0.');
        }
