...
/**
 * CardCountryRule Class Doc Comment
 *
 * @category Class
 * @description Rule matching card issuing country
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardCountryRule extends RiskRule 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardCountryRule';
     ...
     * Sets set
     *
     * @param string[] $set Set of two letter ISO-3166 country codes, with the exception that EU can also be used to indicate all EU countries
     *
     * @return $this
     */
