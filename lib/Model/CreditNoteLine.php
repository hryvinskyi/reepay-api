...
class CreditNoteLine implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 1.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreditNoteLine., must be bigger than or equal to 1.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreditNoteLine., must be bigger than or equal to 1.0.');
        }
