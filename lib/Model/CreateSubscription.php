...
class CreateSubscription implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateSubscription., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateSubscription., must be bigger than or equal to 1.0.');
        }
    ...
    public function setPlanVersion($plan_version)
    {
        ...
        if ($plan_version < 1.0) {
            throw new \InvalidArgumentException('invalid value for $plan_version when calling CreateSubscription., must be bigger than or equal to 1.0.');
        }
    ...
    public function setGraceDuration($grace_duration)
    {
        ...
        if ($grace_duration < 0.0) {
            throw new \InvalidArgumentException('invalid value for $grace_duration when calling CreateSubscription., must be bigger than or equal to 0.0.');
        }
