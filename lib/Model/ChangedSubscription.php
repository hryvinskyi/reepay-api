...
class ChangedSubscription implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['on_hold_reason']) && !in_array(
                $this->container['on_hold_reason'],
                $allowedValues,
                true
            )) {
            $invalidProperties[] = sprintf(
        ...
        if ($this->container['reminder_email_sent'] === null) {
            $invalidProperties[] = "'reminder_email_sent' can't be null";
        }
     ...
     * Sets change_journal
     *
     * @param \Reepay\Model\SubscriptionChangeJournal $change_journal change_journal
     *
     * @return $this
     */
