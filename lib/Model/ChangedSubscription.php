 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChangedSubscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'changeJournal' => '\Reepay\Model\SubscriptionChangeJournal'
    ];
    ...
    protected static $setters = [
        ...
        'changeJournal' => 'setChangeJournal'
    ];
    ...
    protected static $getters = [
        ...
        'changeJournal' => 'getChangeJournal'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['changeJournal'] = isset($data['changeJournal']) ? $data['changeJournal'] : null;
    }
    ...
    public function setRenewalCount($renewalCount)
    {
        ...
        if (($renewalCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $renewalCount when calling ChangedSubscription., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['changeJournal'];
    }

    /**
     * Sets changeJournal
     *
     * @param \Reepay\Model\SubscriptionChangeJournal $changeJournal Object describing the result of a subscription change
     *
     * @return $this
     */
    public function setChangeJournal($changeJournal)
    {
        $this->container['changeJournal'] = $changeJournal;
