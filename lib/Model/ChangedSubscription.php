...
/**
 * ChangedSubscription Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Reepay
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChangedSubscription implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ChangedSubscription';
    ...
    protected static $swaggerTypes = array(
        ...
        'change_journal' => '\Reepay\Model\SubscriptionChangeJournal'
    );
    ...
    protected static $setters = array(
        ...
        'change_journal' => 'setChangeJournal'
    );
    ...
    protected static $getters = array(
        ...
        'change_journal' => 'getChangeJournal'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['change_journal'] = isset($data['change_journal']) ? $data['change_journal'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("active", "expired", "on_hold", "pending");
        ...
        if (($this->container['renewal_count'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'renewal_count', must be bigger than or equal to 0.0.";
        }

        $allowed_values = array("dunning", "cancelled", "ondemand", "fixed");
        if (!in_array($this->container['expire_reason'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'expire_reason', must be one of #{allowed_values}.";
        }

        $allowed_values = array("dunning", "ondemand");
        if (!in_array($this->container['on_hold_reason'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'on_hold_reason', must be one of #{allowed_values}.";
        }
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'active', 'expired', 'on_hold', 'pending'");
        }
    ...
    public function setRenewalCount($renewal_count)
    {
        ...
        if ($renewal_count < 0.0) {
            throw new \InvalidArgumentException('invalid value for $renewal_count when calling ChangedSubscription., must be bigger than or equal to 0.0.');
        }
    ...
    {
        $allowed_values = array('dunning', 'ondemand');
        if (!in_array($on_hold_reason, $allowed_values)) {
     ...
     * @param \Reepay\Model\SubscriptionLinks $hosted_page_links Links to hosted pages relating to subscription
     * @return $this
     */
    ...
    /**
     * Sets pending_change
     * @param \Reepay\Model\SubscriptionChange $pending_change Pending subscription change to be applied at next renewal
     * @return $this
     */
    ...
    /**
     * Gets change_journal
     * @return \Reepay\Model\SubscriptionChangeJournal
     */
    public function getChangeJournal()
    {
        return $this->container['change_journal'];
    }

    /**
     * Sets change_journal
     * @param \Reepay\Model\SubscriptionChangeJournal $change_journal Object describing the result of a subscription change
     * @return $this
     */
    public function setChangeJournal($change_journal)
    {
        $this->container['change_journal'] = $change_journal;
