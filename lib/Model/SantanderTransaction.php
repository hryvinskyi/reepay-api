...
/**
 * SantanderTransaction Class Doc Comment
 *
 * @category Class
 * @description Specifics in case of Santander transaction
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SantanderTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SantanderTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['santander_id'] = isset($data['santander_id']) ? $data['santander_id'] : null;
    }
     ...
     * @return string
     */
    public function getSantanderId()
    {
        return $this->container['santander_id'];
    }

    /**
     * Sets santander_id
     *
     * @param string $santander_id Santander id
     *
     * @return $this
     */
    public function setSantanderId($santander_id)
    {
        $this->container['santander_id'] = $santander_id;
