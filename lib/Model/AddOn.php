...
class AddOn implements ModelInterface, ArrayAccess
{
    ...
    public function setVat($vat)
    {
        ...
        if (!is_null($vat) && ($vat > 1)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling AddOn., must be smaller than or equal to 1.');
        }
        if (!is_null($vat) && ($vat < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling AddOn., must be bigger than or equal to 0.');
        }
