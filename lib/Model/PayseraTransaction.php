...
/**
 * PayseraTransaction Class Doc Comment
 *
 * @category Class
 * @description Specifics in case of Paysera transaction
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayseraTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayseraTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paysera_id'] = isset($data['paysera_id']) ? $data['paysera_id'] : null;
    }
     ...
     * @return string
     */
    public function getPayseraId()
    {
        return $this->container['paysera_id'];
    }

    /**
     * Sets paysera_id
     *
     * @param string $paysera_id Paysera id
     *
     * @return $this
     */
    public function setPayseraId($paysera_id)
    {
        $this->container['paysera_id'] = $paysera_id;
