...
class CardV2 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cardAgreement'] = isset($data['cardAgreement']) ? $data['cardAgreement'] : null;
        ...
        $this->container['declinedCount'] = isset($data['declinedCount']) ? $data['declinedCount'] : null;
     ...
     * Sets declinedCount
     *
     * @param int $declinedCount Number of soft and hard declined attempts for the card since created or since last successful transaction
     *
     * @return $this
     */
