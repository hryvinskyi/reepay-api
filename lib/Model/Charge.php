...
class Charge implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("created", "authorized", "settled", "failed", "cancelled", "pending");
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'created', 'authorized', 'settled', 'failed', 'cancelled', 'pending'");
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Charge., must be bigger than or equal to 0.0.');
        }
