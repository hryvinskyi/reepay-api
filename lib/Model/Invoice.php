...
class Invoice implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("created", "pending", "dunning", "settled", "authorized", "cancelled", "failed");
        ...
        if (!is_null($this->container['number']) && ($this->container['number'] < 1.0)) {
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'created', 'pending', 'dunning', 'settled', 'authorized', 'cancelled', 'failed'");
        }
