...
class CreateSubscriptionInvoice implements ModelInterface, ArrayAccess
{
     ...
     * Sets orderLines
     *
     * @param \Reepay\Model\CreateOrderLine[] $orderLines Optional additional order lines for the invoice
     *
     * @return $this
     */
     ...
     * Sets manualTransfer
     *
     * @param \Reepay\Model\ManualSettleTransfer $manualTransfer Optional manual transfer. If given the invoice will be settled using the manual transfer transaction.
     *
     * @return $this
     */
