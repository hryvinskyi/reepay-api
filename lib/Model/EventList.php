...
class EventList implements ArrayAccess
{
    ...
    public function setPage($page)
    {
        ...
        if ($page < 1.0) {
            throw new \InvalidArgumentException('invalid value for $page when calling EventList., must be bigger than or equal to 1.0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if ($size < 1.0) {
            throw new \InvalidArgumentException('invalid value for $size when calling EventList., must be bigger than or equal to 1.0.');
        }
    ...
    public function setCount($count)
    {
        ...
        if ($count < 0.0) {
            throw new \InvalidArgumentException('invalid value for $count when calling EventList., must be bigger than or equal to 0.0.');
        }
