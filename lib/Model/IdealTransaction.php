...
/**
 * IdealTransaction Class Doc Comment
 *
 * @category Class
 * @description Specifics in case of IDEAL transaction
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdealTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdealTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ideal_id'] = isset($data['ideal_id']) ? $data['ideal_id'] : null;
    }
    ...
    {
        return $this->container['ideal_id'];
    }

    /**
     * Sets ideal_id
     *
     * @param string $ideal_id Ideal id
     *
     * @return $this
     */
    public function setIdealId($ideal_id)
    {
        $this->container['ideal_id'] = $ideal_id;
