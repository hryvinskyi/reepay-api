...
class UpdateSubscriptionPlan implements ArrayAccess
{
    ...
    public function setVat($vat)
    {
        ...
        if ($vat > 1.0) {
            throw new \InvalidArgumentException('invalid value for $vat when calling UpdateSubscriptionPlan., must be smaller than or equal to 1.0.');
        }
        if ($vat < 0.0) {
            throw new \InvalidArgumentException('invalid value for $vat when calling UpdateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setRenewalReminderEmailDays($renewal_reminder_email_days)
    {
        ...
        if ($renewal_reminder_email_days < 1.0) {
            throw new \InvalidArgumentException('invalid value for $renewal_reminder_email_days when calling UpdateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setTrialReminderEmailDays($trial_reminder_email_days)
    {
        ...
        if ($trial_reminder_email_days < 1.0) {
            throw new \InvalidArgumentException('invalid value for $trial_reminder_email_days when calling UpdateSubscriptionPlan., must be bigger than or equal to 1.0.');
        }
    ...
    public function setSetupFee($setup_fee)
    {
        ...
        if ($setup_fee < 0.0) {
            throw new \InvalidArgumentException('invalid value for $setup_fee when calling UpdateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setMinimumProratedAmount($minimum_prorated_amount)
    {
        ...
        if ($minimum_prorated_amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $minimum_prorated_amount when calling UpdateSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
