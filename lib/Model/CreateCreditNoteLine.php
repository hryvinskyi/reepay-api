...
class CreateCreditNoteLine implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateCreditNoteLine., must be bigger than or equal to 1.');
        }
     ...
     * Sets orderLineId
     *
     * @param string $orderLineId Optional reference to invoice order line for which this refund line is related
     *
     * @return $this
     */
