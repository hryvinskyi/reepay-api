...
class ChangeSubscription implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['timing'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'timing', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['billing'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'billing', must be one of #{allowed_values}.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ChangeSubscription., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ChangeSubscription., must be bigger than or equal to 1.0.');
        }
    ...
    {
        $allowed_values = array('prorated', 'full', 'zero_amount', 'none');
        if (!in_array($billing, $allowed_values)) {
