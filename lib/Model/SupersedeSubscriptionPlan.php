 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupersedeSubscriptionPlan implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'supersedeMode' => 'setSupersedeMode'
    ];
    ...
    protected static $getters = [
        ...
        'supersedeMode' => 'getSupersedeMode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['supersedeMode'] = isset($data['supersedeMode']) ? $data['supersedeMode'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['supersedeMode']) && !in_array($this->container['supersedeMode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'supersedeMode', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setVat($vat)
    {
        ...
        if (!is_null($vat) && ($vat > 1)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling SupersedeSubscriptionPlan., must be smaller than or equal to 1.');
        }
        if (!is_null($vat) && ($vat < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setRenewalReminderEmailDays($renewalReminderEmailDays)
    {
        ...
        if (!is_null($renewalReminderEmailDays) && ($renewalReminderEmailDays < 1)) {
            throw new \InvalidArgumentException('invalid value for $renewalReminderEmailDays when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setTrialReminderEmailDays($trialReminderEmailDays)
    {
        ...
        if (!is_null($trialReminderEmailDays) && ($trialReminderEmailDays < 1)) {
            throw new \InvalidArgumentException('invalid value for $trialReminderEmailDays when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setSetupFee($setupFee)
    {
        ...
        if (!is_null($setupFee) && ($setupFee < 0)) {
            throw new \InvalidArgumentException('invalid value for $setupFee when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setMinimumProratedAmount($minimumProratedAmount)
    {
        ...
        if (!is_null($minimumProratedAmount) && ($minimumProratedAmount < 0)) {
            throw new \InvalidArgumentException('invalid value for $minimumProratedAmount when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setFixedCount($fixedCount)
    {
        ...
        if (!is_null($fixedCount) && ($fixedCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixedCount when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedLifeTimeLength($fixedLifeTimeLength)
    {
        ...
        if (!is_null($fixedLifeTimeLength) && ($fixedLifeTimeLength < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixedLifeTimeLength when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setTrialIntervalLength($trialIntervalLength)
    {
        ...
        if (!is_null($trialIntervalLength) && ($trialIntervalLength < 1)) {
            throw new \InvalidArgumentException('invalid value for $trialIntervalLength when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setIntervalLength($intervalLength)
    {
        ...
        if (($intervalLength < 1)) {
            throw new \InvalidArgumentException('invalid value for $intervalLength when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setScheduleFixedDay($scheduleFixedDay)
    {
        ...
        if (!is_null($scheduleFixedDay) && ($scheduleFixedDay > 28)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedDay when calling SupersedeSubscriptionPlan., must be smaller than or equal to 28.');
        }
        if (!is_null($scheduleFixedDay) && ($scheduleFixedDay < 1)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedDay when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setBaseMonth($baseMonth)
    {
        ...
        if (!is_null($baseMonth) && ($baseMonth > 12)) {
            throw new \InvalidArgumentException('invalid value for $baseMonth when calling SupersedeSubscriptionPlan., must be smaller than or equal to 12.');
        }
        if (!is_null($baseMonth) && ($baseMonth < 1)) {
            throw new \InvalidArgumentException('invalid value for $baseMonth when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setNoticePeriods($noticePeriods)
    {
        ...
        if (!is_null($noticePeriods) && ($noticePeriods < 0)) {
            throw new \InvalidArgumentException('invalid value for $noticePeriods when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setFixationPeriods($fixationPeriods)
    {
        ...
        if (!is_null($fixationPeriods) && ($fixationPeriods < 0)) {
            throw new \InvalidArgumentException('invalid value for $fixationPeriods when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['supersedeMode'];
    }

    /**
     * Sets supersedeMode
     *
     * @param string $supersedeMode Action to take after a subscription plan is superseded, one of the following: `no_sub_update`, `scheduled_sub_update`. Default is `no_sub_update`.
     *
     * @return $this
     */
    public function setSupersedeMode($supersedeMode)
    {
        $allowedValues = $this->getSupersedeModeAllowableValues();
        if (!is_null($supersedeMode) && !in_array($supersedeMode, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'supersedeMode', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['supersedeMode'] = $supersedeMode;
