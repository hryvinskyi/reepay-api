...
class SupersedeSubscriptionPlan implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("no_sub_update", "scheduled_sub_update");
    ...
    public function setSetupFee($setup_fee)
    {
        ...
        if ($setup_fee < 0.0) {
            throw new \InvalidArgumentException('invalid value for $setup_fee when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setMinimumProratedAmount($minimum_prorated_amount)
    {
        ...
        if ($minimum_prorated_amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $minimum_prorated_amount when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setNoticePeriods($notice_periods)
    {
        ...
        if ($notice_periods < 0.0) {
            throw new \InvalidArgumentException('invalid value for $notice_periods when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    public function setFixationPeriods($fixation_periods)
    {
        ...
        if ($fixation_periods < 0.0) {
            throw new \InvalidArgumentException('invalid value for $fixation_periods when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.0.');
        }
    ...
    /**
     * Sets supersede_mode
     * @param string $supersede_mode Action to take after a subscription plan is superseded, one of the following: `no_sub_update`, `scheduled_sub_update`. Default is `no_sub_update`.
     * @return $this
     */
    public function setSupersedeMode($supersede_mode)
    {
        ...
        if (!in_array($supersede_mode, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'supersede_mode', must be one of 'no_sub_update', 'scheduled_sub_update'");
        }
