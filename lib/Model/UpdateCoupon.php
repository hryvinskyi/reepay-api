 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateCoupon implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_redemptions']) && ($this->container['max_redemptions'] < 1.0)) {
            $invalid_properties[] = "invalid value for 'max_redemptions', must be bigger than or equal to 1.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['max_redemptions'] < 1.0) {
            return false;
        }
        return true;
    }
    ...
    public function setMaxRedemptions($max_redemptions)
    {
        ...
        if ($max_redemptions < 1.0) {
            throw new \InvalidArgumentException('invalid value for $max_redemptions when calling UpdateCoupon., must be bigger than or equal to 1.0.');
        }
