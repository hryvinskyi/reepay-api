 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateDiscount implements ModelInterface, ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling UpdateDiscount., must be bigger than or equal to 0.');
        }
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling UpdateDiscount., must be smaller than or equal to 100.');
        }
        if (!is_null($percentage) && ($percentage < 1)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling UpdateDiscount., must be bigger than or equal to 1.');
        }
