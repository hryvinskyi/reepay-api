...
class UpdateWebhookSettings implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['alert_count']) && ($this->container['alert_count'] < 4.0)) {
            $invalid_properties[] = "invalid value for 'alert_count', must be bigger than or equal to 4.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['alert_count'] < 4.0) {
            return false;
        }
        return true;
    }
    ...
    public function setAlertCount($alert_count)
    {
        ...
        if ($alert_count < 4.0) {
            throw new \InvalidArgumentException('invalid value for $alert_count when calling UpdateWebhookSettings., must be bigger than or equal to 4.0.');
        }
