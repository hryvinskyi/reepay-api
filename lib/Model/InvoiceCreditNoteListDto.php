...
/**
 * InvoiceCreditNoteListDto Class Doc Comment
 *
 * @category Class
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceCreditNoteListDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceCreditNoteListDto';
    ...
    protected static $swaggerTypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Reepay\Model\InvoiceCreditNoteV2[]',
        'range' => 'string',
     ...
     * Gets content
     *
     * @return \Reepay\Model\InvoiceCreditNoteV2[]
     */
     ...
     * Sets content
     *
     * @param \Reepay\Model\InvoiceCreditNoteV2[] $content List of credit notes for current page
     *
     * @return $this
     */
     ...
     * Sets range
     *
     * @param string $range Time and date attribute used to time limit. Only `created` could be present.
     *
     * @return $this
     */
