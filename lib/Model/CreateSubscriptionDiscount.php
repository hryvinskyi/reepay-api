...
class CreateSubscriptionDiscount implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 1.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateSubscriptionDiscount., must be bigger than or equal to 1.0.');
        }
    ...
    public function setPercentage($percentage)
    {
        ...
        if ($percentage > 100.0) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling CreateSubscriptionDiscount., must be smaller than or equal to 100.0.');
        }
        if ($percentage < 1.0) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling CreateSubscriptionDiscount., must be bigger than or equal to 1.0.');
        }
    ...
    public function setFixedCount($fixed_count)
    {
        ...
        if ($fixed_count < 1.0) {
            throw new \InvalidArgumentException('invalid value for $fixed_count when calling CreateSubscriptionDiscount., must be bigger than or equal to 1.0.');
        }
    ...
    public function setFixedPeriod($fixed_period)
    {
        ...
        if ($fixed_period < 1.0) {
            throw new \InvalidArgumentException('invalid value for $fixed_period when calling CreateSubscriptionDiscount., must be bigger than or equal to 1.0.');
        }
