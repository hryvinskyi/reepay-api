...
/**
 * DiscountList Class Doc Comment
 *
 * @category Class
 * @description A page in a paginated discount list
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DiscountList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DiscountList';
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DiscountList., must be smaller than or equal to 100.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DiscountList., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100)) {
            throw new \InvalidArgumentException('invalid value for $count when calling DiscountList., must be smaller than or equal to 100.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling DiscountList., must be bigger than or equal to 0.');
        }
