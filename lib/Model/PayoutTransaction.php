 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PayoutTransaction implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("paid", "processing", "failed");
        ...
        $allowed_values = array("reepay", "clearhaus", "nets", "swedbank", "handelsbanken", "elavon", "bambora", "valitor", "dibs", "stripe", "quickpay", "test");
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'paid', 'processing', 'failed'");
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PayoutTransaction., must be bigger than or equal to 0.0.');
        }
    ...
    /**
     * Sets provider
     * @param string $provider Acquirer or payment gateway used: `reepay`, `clearhaus`, `nets`, `swedbank`, `handelsbanken`, `elavon`, `bambora`, `valitor`, `dibs`, `stripe`, `quickpay`, `test`
     * @return $this
     */
    public function setProvider($provider)
    {
        ...
        if (!in_array($provider, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'provider', must be one of 'reepay', 'clearhaus', 'nets', 'swedbank', 'handelsbanken', 'elavon', 'bambora', 'valitor', 'dibs', 'stripe', 'quickpay', 'test'");
        }
