...
/**
 * TaxPolicyList Class Doc Comment
 *
 * @category Class
 * @description A page in a paginated tax policy list
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaxPolicyList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaxPolicyList';
    ...
    protected static $swaggerTypes = [
        ...
        'from' => 'string',
        'range' => 'string',
        'content' => '\Reepay\Model\TaxPolicy[]',
     ...
     * Sets content
     *
     * @param \Reepay\Model\TaxPolicy[] $content List of tax policies for current page
     *
     * @return $this
     */
