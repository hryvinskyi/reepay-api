 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PreparedSubscription implements ArrayAccess
{
    /**
    ...
    public function setRenewalCount($renewal_count)
    {
        ...
        if ($renewal_count < 0.0) {
            throw new \InvalidArgumentException('invalid value for $renewal_count when calling PreparedSubscription., must be bigger than or equal to 0.0.');
        }
