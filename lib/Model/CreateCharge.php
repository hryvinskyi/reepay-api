...
class CreateCharge implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 1.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateCharge., must be bigger than or equal to 1.0.');
        }
    ...
    public function setTextOnStatement($text_on_statement)
    {
        ...
        if (!preg_match("^[\\x20-\\x7F]*$", $text_on_statement)) {
            throw new \InvalidArgumentException('invalid value for $text_on_statement when calling CreateCharge., must be conform to the pattern ^[\\x20-\\x7F]*$.');
        }
