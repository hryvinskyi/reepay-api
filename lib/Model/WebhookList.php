 ...
 *
 * @category Class
 * @description A page in a paginated webhook list
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebhookList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebhookList';
     ...
     * Sets content
     *
     * @param \Reepay\Model\Webhook[] $content List of webhooks for current page
     *
     * @return $this
     */
