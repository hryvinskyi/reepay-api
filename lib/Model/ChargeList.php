 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChargeList implements ArrayAccess
{
    /**
    ...
    public function setSize($size)
    {
        ...
        if ($size > 100.0) {
            throw new \InvalidArgumentException('invalid value for $size when calling ChargeList., must be smaller than or equal to 100.0.');
        }
        if ($size < 1.0) {
            throw new \InvalidArgumentException('invalid value for $size when calling ChargeList., must be bigger than or equal to 1.0.');
        }
    ...
    public function setCount($count)
    {
        ...
        if ($count > 100.0) {
            throw new \InvalidArgumentException('invalid value for $count when calling ChargeList., must be smaller than or equal to 100.0.');
        }
        if ($count < 0.0) {
            throw new \InvalidArgumentException('invalid value for $count when calling ChargeList., must be bigger than or equal to 0.0.');
        }
