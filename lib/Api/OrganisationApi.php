...
class OrganisationApi
{
    ...
    {
        $returnType = '\Reepay\Model\Organisation';
    ...
    {
        return $this->getOrganisationAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getOrganisationRequest()
    {
     ...
     * Update organisation
     *
     * @param  \Reepay\Model\UpdateOrganisation $body body (required)
     *
     * @throws \Reepay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Reepay\Model\Organisation
     ...
     * Update organisation
     *
     * @param  \Reepay\Model\UpdateOrganisation $body (required)
     *
     * @throws \Reepay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Reepay\Model\Organisation, HTTP status code, HTTP response headers (array of strings)
