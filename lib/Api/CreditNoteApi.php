...
class CreditNoteApi
{
    ...
    {
        list($response) = $this->getCreditNoteWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Reepay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Reepay\Model\InvoiceCreditNoteV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditNoteWithHttpInfo($id)
    {
        $returnType = '\Reepay\Model\InvoiceCreditNoteV2';
     ...
     */
    public function getCreditNoteAsync($id)
    {
        return $this->getCreditNoteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getCreditNoteRequest($id)
    {
