...
class UserApi
{
    ...
    {
        list($response) = $this->cancelInvitationWithHttpInfo($id);
        return $response;
    }
    ...
    public function cancelInvitationWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling cancelInvitation');
        }
        // parse inputs
    ...
    public function getUserWithHttpInfo($id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\UserAccount', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getUserMfaWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getUserMfa');
        }
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\UserAccountMfa', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Reepay\Model\UserAccountMfa', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Reepay\Model\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        list($response) = $this->resetPasswordWithHttpInfo($version, $body);
        return $response;
    }
    ...
    public function resetPasswordWithTokenWithHttpInfo($token, $body = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\User', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function setMfaWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling setMfa');
        }
        // parse inputs
        $resourcePath = "/v1/user/{id}/mfa";
        $httpBody = '';
