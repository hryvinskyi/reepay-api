...
class CustomerApi
{
    ...
    public function addCardJsonWithHttpInfo($handle, $body = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\Card', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
     ...
     *
     * @param string $handle Customer handle (required)
     * @param \Reepay\Model\CardCopy $body  (optional)
     * @return \Reepay\Model\Card
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function cardCopy($handle, $body = null)
    {
        list($response) = $this->cardCopyWithHttpInfo($handle, $body);
        return $response;
    }

    /**
     * Operation cardCopyWithHttpInfo
     *
     * Copy card payment method
     *
     * @param string $handle Customer handle (required)
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function cardCopyWithHttpInfo($handle, $body = null)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling cardCopy');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/payment_method/card_copy";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Reepay\Model\Card',
                '/v1/customer/{handle}/payment_method/card_copy'
            );
    ...
    public function createCustomerJsonWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\Customer', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function createCustomerNoteJsonWithHttpInfo($handle, $body = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\CustomerNote', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    {
        list($response) = $this->deleteMetadata1WithHttpInfo($handle);
        return $response;
    }
    ...
    public function deleteMetadata1WithHttpInfo($handle)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling deleteMetadata1');
        }
        // parse inputs
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function deletePaymentMethod($handle, $method_id)
    {
        list($response) = $this->deletePaymentMethodWithHttpInfo($handle, $method_id);
        return $response;
    }
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function deletePaymentMethodWithHttpInfo($handle, $method_id)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling deletePaymentMethod');
        }
        // verify the required parameter 'method_id' is set
        if ($method_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $method_id when calling deletePaymentMethod');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/payment_method/{method_id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Reepay\Model\PaymentMethods',
                '/v1/customer/{handle}/payment_method/{method_id}'
            );
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getCustomers($page = null, $size = null, $search = null)
    {
        list($response) = $this->getCustomersWithHttpInfo($page, $size, $search);
        return $response;
    }
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getCustomersWithHttpInfo($page = null, $size = null, $search = null)
    {
        if (!is_null($page) && ($page > 1.0E7)) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling CustomerApi.getCustomers, must be smaller than or equal to 1.0E7.');
        }
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\CustomerSearch', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getMetadata1WithHttpInfo($handle)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling getMetadata1');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/metadata";
        $httpBody = '';
    ...
    /**
     * Operation getMpsDetails
     *
     * Get MobilePay Subscriptions agreement details
     *
     * @param string $handle Customer handle (required)
     * @param string $id Mps subscription id (required)
     * @return map[string,object]
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getMpsDetails($handle, $id)
    {
        list($response) = $this->getMpsDetailsWithHttpInfo($handle, $id);
        return $response;
    }

    /**
     * Operation getMpsDetailsWithHttpInfo
     *
     * Get MobilePay Subscriptions agreement details
     *
     * @param string $handle Customer handle (required)
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getMpsDetailsWithHttpInfo($handle, $id)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling getMpsDetails');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getMpsDetails');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/payment_method/mps/{id}/details";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                'map[string,object]',
                '/v1/customer/{handle}/payment_method/mps/{id}/details'
            );
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getMpsSubscription($handle, $id)
    {
        list($response) = $this->getMpsSubscriptionWithHttpInfo($handle, $id);
        return $response;
    }

    /**
     * Operation getMpsSubscriptionWithHttpInfo
     *
     * Get MobilePay Subscriptions agreement
     *
     * @param string $handle Customer handle (required)
     * @param string $id Mps subscription id (required)
     * @return Array of \Reepay\Model\MpsSubscription, HTTP status code, HTTP response headers (array of strings)
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function getMpsSubscriptionWithHttpInfo($handle, $id)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling getMpsSubscription');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getMpsSubscription');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/payment_method/mps/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Reepay\Model\MpsSubscription',
                '/v1/customer/{handle}/payment_method/mps/{id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\MpsSubscription', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Reepay\Model\MpsSubscription', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Reepay\Model\ErrorResponse', $e->getResponseHeaders());
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function updateMetadata1($handle, $body = null)
    {
        list($response) = $this->updateMetadata1WithHttpInfo($handle, $body);
        return $response;
    }
     ...
     * @throws \Reepay\ApiException on non-2xx response
     */
    public function updateMetadata1WithHttpInfo($handle, $body = null)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null) {
            throw new \InvalidArgumentException('Missing the required parameter $handle when calling updateMetadata1');
        }
        // parse inputs
        $resourcePath = "/v1/customer/{handle}/metadata";
        $httpBody = '';
