...
class MailTemplateApi
{
     ...
     * @return \Reepay\Model\InlineResponse200
     */
     ...
     * @throws \Reepay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Reepay\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSampleWithHttpInfo()
    {
        $returnType = '\Reepay\Model\InlineResponse200';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Reepay\Model\InlineResponse200',
     ...
     */
    public function getSampleAsync()
    {
        return $this->getSampleAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSampleAsyncWithHttpInfo()
    {
        $returnType = '\Reepay\Model\InlineResponse200';
        $request = $this->getSampleRequest();
