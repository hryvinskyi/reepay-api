...
class PaymentMethodApi
{
    ...
    {
        list($response) = $this->copyCardPaymentMethodV2WithHttpInfo($id, $body);
        return $response;
    }
    ...
    {
        $returnType = '\Reepay\Model\PaymentMethodV2';
        $request = $this->copyCardPaymentMethodV2Request($id, $body);
    ...
    {
        return $this->copyCardPaymentMethodV2AsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->moveCardPaymentMethodV2WithHttpInfo($id, $body);
        return $response;
    }
    ...
    {
        $returnType = '\Reepay\Model\PaymentMethodV2';
        $request = $this->moveCardPaymentMethodV2Request($id, $body);
    ...
    {
        return $this->moveCardPaymentMethodV2AsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
