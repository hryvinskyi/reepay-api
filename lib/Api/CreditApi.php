...
class CreditApi
{
     ...
     * Create credit
     *
     * @param  \Reepay\Model\CreateCredit $body body (optional)
     *
     * @throws \Reepay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Reepay\Model\Credit
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditJsonAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCreditJsonAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Reepay\Model\Credit';
        $request = $this->createCreditJsonRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCreditJsonRequest($body = null)
    {
