...
class RefundApi
{
     ...
     * Create refund
     *
     * @param  \Reepay\Model\CreateRefund $body body (optional)
     *
     ...
     */
    public function createRefundAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRefundAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Reepay\Model\Refund';
        $request = $this->createRefundRequest($body);
     ...
     */
    protected function createRefundRequest($body = null)
    {
