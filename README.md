...
- API version: 1
- Build date: 2022-03-07T14:19:04.430+02:00
...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/GIT_USER_ID/reepay-api.git"
    }
  ],
  "require": {
    "GIT_USER_ID/reepay-api": "*@dev"
  }
}
```
...
*AddonApi* | [**getAddOns**](docs/Api/AddonApi.md#getaddons) | **GET** /v1/add_on | Get list of add-ons
...
*AgreementApi* | [**createPgwAgreement**](docs/Api/AgreementApi.md#createpgwagreement) | **POST** /v1/agreement/pgw | Create payment gateway agreement
...
*AgreementApi* | [**updatePgwAgreement**](docs/Api/AgreementApi.md#updatepgwagreement) | **PUT** /v1/agreement/pgw/{id} | Update pgw agreement
...
*CustomerApi* | [**cardCopy**](docs/Api/CustomerApi.md#cardcopy) | **POST** /v1/customer/{handle}/payment_method/card_copy | Copy card payment method
...
*CustomerApi* | [**deletePaymentMethod**](docs/Api/CustomerApi.md#deletepaymentmethod) | **DELETE** /v1/customer/{handle}/payment_method/{method_id} | Delete payment method
...
*CustomerApi* | [**getMpsDetails**](docs/Api/CustomerApi.md#getmpsdetails) | **GET** /v1/customer/{handle}/payment_method/mps/{id}/details | Get MobilePay Subscriptions agreement details
*CustomerApi* | [**getMpsSubscription**](docs/Api/CustomerApi.md#getmpssubscription) | **GET** /v1/customer/{handle}/payment_method/mps/{id} | Get MobilePay Subscriptions agreement
...
## Documentation For Models
 ...
 - [CardCopy](docs/Model/CardCopy.md)
 ...
 - [PgwAgreement](docs/Model/PgwAgreement.md)
 ...
 - [UpdatePgwAgreement](docs/Model/UpdatePgwAgreement.md)
